...
func Test_parsePath(t *testing.T) {
	tests := []struct {
		...
		{"11", "tag[41].2", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathBit, val: 2}}},
		{"12", "tag3.count.10", []pathEl{{typ: ansiExtended, txt: "tag3"}, {typ: ansiExtended, txt: "count"}, {typ: pathBit, val: 10}}},
		{"11", "tag[41]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}}},
		{"11", "tag[  41]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}}},
		{"11", "tag[ 41  ]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}}},
		{"11", "tag[41  ]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}}},
		{"11", "tag[41][1]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 1}}},
		{"11", "tag[41][11][2]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 11}, {typ: pathElement, val: 2}}},
		{"11", "tag[41][11][2].x", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 11}, {typ: pathElement, val: 2}, {typ: ansiExtended, txt: "x"}}},
		{"11", "tag[41][11][2].1", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 11}, {typ: pathElement, val: 2}, {typ: pathBit, val: 1}}},
		{"11", "tag[41,1]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 1}}},
		{"11", "tag[ 41, 1]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 1}}},
		{"11", "tag[41 ,1]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 1}}},
		{"11", "tag[41 , 1]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 41}, {typ: pathElement, val: 1}}},
		...
		{"13", "tag3[5].count", []pathEl{{typ: ansiExtended, txt: "tag3"}, {typ: pathElement, val: 5}, {typ: ansiExtended, txt: "count"}}},
		{"14", "tag.count[712]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: ansiExtended, txt: "count"}, {typ: pathElement, val: 712}}},
		{"15", "tag[6].count[7]", []pathEl{{typ: ansiExtended, txt: "tag"}, {typ: pathElement, val: 6}, {typ: ansiExtended, txt: "count"}, {typ: pathElement, val: 7}}},
	}
